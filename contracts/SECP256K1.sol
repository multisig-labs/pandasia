...
library SECP256K1 {
	...
	/// @return (x, y) EC point
	function recover(uint256 digest, uint8 v, uint256 r, uint256 s) public pure returns (uint256, uint256) {
	...
	function jacAdd(uint256 _x1, uint256 _y1, uint256 _z1, uint256 _x2, uint256 _y2, uint256 _z2) internal pure returns (uint256, uint256, uint256) {
	...
	function jacMul(uint256 _d, uint256 _x, uint256 _y, uint256 _z) internal pure returns (uint256, uint256, uint256) {
	...
	function ecAdd(uint256 _x1, uint256 _y1, uint256 _z1, uint256 _x2, uint256 _y2, uint256 _z2) internal pure returns (uint256, uint256) {
		uint256 x = 0;
		uint256 y = 0;
		uint256 z = 0;
